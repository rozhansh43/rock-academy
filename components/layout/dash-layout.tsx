...
const DashLayout: FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    ...
    <div className="mx-auto size-full max-w-md bg-linear-8 bg-gradient-to-t from-orange-50 from-[53.7%] to-purple-100 to-[97.64%] pb-40">
      {children}
