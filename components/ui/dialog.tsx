    ...
    <DialogPortal>
      ...
      >
        ...
        {showCloseButton && (
          <DialogClose
            asChild
            className="ring-offset-background data-[state=open]:bg-accent data-[state=open]:text-muted-foreground absolute end-5 top-5 cursor-pointer rounded-sm opacity-60 outline-0 transition-opacity hover:opacity-100 focus:outline-hidden disabled:pointer-events-none"
          >
            <Button
              variant="outline"
              mode="icon"
