...
function InputOTPSlot({
  ...
  return (
    <div
      ...
      className={cn(
        'border-light-1 focus:border-ring relative flex h-13.5 w-13.5 items-center justify-center rounded-xl border border-y bg-white text-sm outline-hidden transition-all',
