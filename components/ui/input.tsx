...
const inputVariants = cva(
  `
    ...
    focus-visible:outline-none focus-visible:shadow-sm focus-visible:shadow-black/10
  ...
  `,
  {
    variants: {
      variant: {
        lg: 'h-13 px-4 text-base rounded-2xl file:pe-4 file:me-4',
...
const inputWrapperVariants = cva(
  `
    ...
    has-[:focus-visible]:shadow-black/10
